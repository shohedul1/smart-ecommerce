      ...
      <div>
       ...
       <div className="w-full h-96 group overflow-hidden relative">
          ...
          {item?.attributes?.isNew && (
            ...
            <span className="absolute top-2 right-2 font-medium text-xs py-1 px-3 rounded-full group-hover:bg-orange-600 bg-white duration-200 group-hover:text-white">
              new Arrival
            </span>
          )}
        </div>
