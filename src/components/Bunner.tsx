    ...
    return (
        <div className="relative">
            ...
            <div className="w-full h-full relative">
                    ...
                    priority/>
                 <BannerText title="Outware Picks" description="this is fris products"/>
                </div>
                <div className="w-full h-full relative">
                    <Image src={image2} alt="image1"
                    className="w-full h-[550px] relative"
                    priority/>
                 <BannerText title="Seasonal Offers" description="this secound products"/>
                </div>
                <div>
                    <Image src={image3} alt="image3"
                    className="w-full  h-[550px] relative"
                    priority/>
                     <BannerText title="Best for men" description="this therd product"/>
                </div>   
            </Slider>
